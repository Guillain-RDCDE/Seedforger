...
[`Seedforger.Core/BitTorrent/BEncode.cs`](../src/Seedforger.Core/BitTorrent/BEncode.cs); it's
...
[`Seedforger.Core/BitTorrent/Torrent.cs`](../src/Seedforger.Core/BitTorrent/Torrent.cs) (`InfoHash`),
...
([`DefaultClientProfiles.cs`](../src/Seedforger.Core/DefaultClientProfiles.cs)) stores the
...
[`Seedforger.Core/Magnet.cs`](../src/Seedforger.Core/Magnet.cs), then ask for the size).
...
[`Seedforger.Core/Peer/`](../src/Seedforger.Core/Peer/)):
